...
function Page_11() {
  ...
  return (
    <>
      <section className='page-cover page_11-wrap text-center' onScroll={(e) => handleScroll(e)}>
        <div className={scrollPosition}>
          <h1> A Brief Recap of what you've learnt</h1>
        </div>
          ...
          <div className="accordion card-container" id="accordionExample">
            ...
            <div className="card">
              <div className="card-header" id="headingTwo">
                <button className="btn-block default-btn accordion-cta mb-3" onClick={(e) => addClassActive(e)} type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
            ...
            <div className="card ">
              <div className="card-header" id="headingThree">
                <button className="btn-block default-btn accordion-cta mb-3" onClick={(e) => addClassActive(e)} type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
            ...
            <div className="card ">
              <div className="card-header" id="headingFour">
                <button className="btn-block default-btn accordion-cta mb-3" onClick={(e) => addClassActive(e)} type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
            ...
            <div className="card ">
              <div className="card-header" id="headingFive">
                <button className="btn-block default-btn accordion-cta mb-3" onClick={(e) => addClassActive(e)} type="button" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
            ...
            <div className="card ">
              <div className="card-header" id="headingSix">
                <button className="btn-block default-btn accordion-cta mb-3" onClick={(e) => addClassActive(e)} type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
